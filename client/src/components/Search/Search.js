  ...
  <div className="container-fluid">
      <div className="panel panel-default">
        <div className="panel-heading">
          <h3><i className="fa fa-search"></i> Search Below </h3>
        </div>
        <div className="panel-body">
          <form id ="form-body">
            ...
            <div className="form-group">
              <label for="year-initial">Start Year : </label>
            ...
            <button type="submit" className="btn btn-primary" id="submit-search"><i className="fa fa-search"></i> Search</button>
